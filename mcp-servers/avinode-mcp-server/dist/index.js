...
const tools = [
    ...
    {
        name: 'create_trip',
        description: 'Create a trip container in Avinode and return a deep link for manual operator selection. This is the primary tool for initiating the flight search workflow.',
        inputSchema: {
            type: 'object',
            properties: {
                departure_airport: {
