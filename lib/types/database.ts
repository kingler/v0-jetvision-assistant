    ...
    Tables: {
      ...
      contracts: {
        Row: {
          ...
          domestic_segment_fee: number | null
          email_message_id: string | null
          expired_at: string | null
          federal_excise_tax: number | null
          ...
          id: string
          iso_agent_id: string
          jetvision_signature_data: string | null
          jetvision_signed_date: string | null
          jetvision_signed_name: string | null
          metadata: Json | null
          passengers: number
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "contracts_iso_agent_id_fkey"
            columns: ["iso_agent_id"]
            isOneToOne: false
            referencedRelation: "iso_agents"
            referencedColumns: ["id"]
      ...
      proposals: {
        Row: {
          ...
          email_approval_status: string | null
          email_approved_at: string | null
          email_body: string | null
          email_draft_body: string | null
          email_draft_generated_at: string | null
